...
impl frame_system::Config for Runtime {
	...
	/// The ubiquitous origin type.impl pallet_insecure_randomness_collective_flip::Config for
	/// Runtime {} Converts a module to the index of the module in `construct_runtime!`.
	///
